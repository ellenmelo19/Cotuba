...
C4Container
    ...
    System_Boundary(cotubify, "Plataforma Cotubify") {
        ...
        Container(gerador, "Serviço Gerador de Ebooks", "Java, Spring Boot", "Clona o repositório e gera PDF/EPUB com o motor Cotuba.")
    ...
    Rel(api, db, "Persiste e consulta dados", "JDBC / SQL")
    Rel(api, gerador, "Solicita geração ao criar/editar livro", "HTTPS / REST")
